...
import static com.joyner.patterns.prototype.AccessControlProvider.getAccessControlObject;

public class TestPrototypePattern {

    public static void main(String[] args) {
        AccessControl userAccessControl = getAccessControlObject("USER");
        User user = new User("User A", "USER Level", userAccessControl);
        System.out.println("************************************");
        System.out.println(user);
        userAccessControl = getAccessControlObject("USER");
